...
try:
	...
	while running:
		...
		| \| | | | | |   / _ \ __| __| _ \ 
		| .` | |_| | |__| (_) \__ \ _||   /
		|_|\_|\___/|____|\___/|___/___|_|_\ \033[97m
		\033[92m\033[92m
		''')
		print("	\033[97m=========================================================== ")
		...
		[46] C++ para gamers
		[47] Banner FSOCIETY
		[48] Golang para hackers éticos
		[49] Perl para hackers éticos
		[50] Ruby para hackers éticos
		[51] Python para hacking ético
		[52] Bash para hackers éticos
		[53] Sobre esta ferramenta
		[54] Atualizar NullSec
		...
		if select == '1':
			...
			os.system("python tools/NullSec.py")
			os.system("clear")
		elif select == '6':
			os.system("clear")
			...
			os.system("clear")
			os.system("python tools/arp-verification.py")
			os.system("clear")
		elif select == '23':
			os.system("clear")
			...
			os.system("clear")
			os.system("python tools/encrypt-cli.py")
			os.system("clear")
		elif select == '35':
			os.system("clear")
			os.system("python tools/decrypt-cli.py")
			os.system("clear")
		elif select == '36':
			os.system("clear")
			...
			os.system("clear")
			os.system("python tools/NullSec-engine.py")
			os.system("clear")
		elif select == '43':
			os.system("clear")
			...
			os.system("clear")
			os.system("python tools/python-for-ethical-hacking.py")
			os.system("clear")
		elif select == '52':
			os.system("clear")
			os.system("python tools/bash-for-ethical-hacking.py")
			os.system("clear")
		elif select == '53':
			os.system("clear")
			os.system("python tools/about-tool.py")
			os.system("clear")
		elif select == '54':
			os.system("clear")
			os.system("python tools/update-nullsec.py")
			os.system("clear")
		elif select == '00':
			os.system("clear")
