...
logo = '''
 ...
 |__,|_|_|_|  |_|  |__,|_|_|___|_|_|_  |_|_|_|___|___|___|    |_|  
                                   |___|               
     code from R3DHULK       github page : https://github.com/blacktracee
'''
print(logo)
...
def main():
    publico_ip = fetch_public_ip()
    cidade = resolve_city(publico_ip)
    pais = resolve_country(publico_ip)
    ...
    print('///////////////////////////////////////////////')
    print('PI público:   {}'.format(publico_ip))
    print('Localização:    {}, {}'.format(cidade, pais))
    print('\n')
