...
Label(root, text="NullSec-BROWSER", font="Helvtica 24 bold",background='green').place(x=100,y=10)
Label(root,text="(Clique nos botões para abrir o site)",font="LUCIDA 18", background='green').place(x=100,y=50)
