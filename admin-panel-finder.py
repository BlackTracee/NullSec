...
try:
	def slowprint(s):
		for c in s + '\n' :
			...
			sys.stdout.flush()
			time.sleep(10. / 100)
	slowprint(" \033[91m************* Carregamento de tela para você *************** ")
	def bannerprint(h):
		for c in h + '\n' :
			sys.stdout.write(c)
			sys.stdout.flush()
 ...
 | || / _ \ || | '_| / _` / _` | '  \| | ' \ 
  ...
  |__/        coded by BlackTrace                                
  github page : https://github.com/BlackTraceblacktracee
''')
	def slowprint(s):
		for c in s + '\n' :
			sys.stdout.write(c)
			sys.stdout.flush()
			time.sleep(10. / 100)
	slowprint(" [!] RESPEITE A PRIVACIDADE DOS OUTROS ")
	time.sleep(2)
	os.system('clear')
	print('''\033[92m
  _                                          
...
''')
	print(" \033[95m VOCÊ DEVE ESCREVER PROTOCOLE HTTPS:// ou HTTP:// ex: http://www.ex.com , ex :https://www.ex.com ")
	print(" \033[95m VOCÊ DEVE ESCREVER / NO FINAL DO SITE EX: http://www.example.com ou https://www.example.com/")
	print("                                                                       ")
	url = input("\033[94m [+] A NullSec quer que você entre no site da Target: ")
	input("\n\033[91m [*] A estratégia de ataque está carregada... Entre para continuar ou Ctrl+C para sair")
	...
	def slowprint(f):
		for c in f + '\n' :
			...
			sys.stdout.flush()
			time.sleep(10. / 100)
	slowprint('''\033[91m [+] NullSec está em andamento... Sinta-se à vontade para pressionar Ctrl+C a qualquer momento para abortar... ''')
	time.sleep(2)
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf','cpanel','cpanel.php','cpanel.html',)
	for hani in passe :
		...
		try :
			...
			print("                                                            			   ")
			print("\033[92m :::: ALERTE::: PÁGINA DE ADMINISTRAÇÃO FOI ENCONTRADA ::: "+curl)
			print("________________________________________________________________________")
		except urllib.error.URLError as msg :
			print ("\033[91m **** DESCULPE NÃO ENCONTRADO ::: "+curl)
...
try:
	...
	def slowprint(f):
		for c in f + '\n' :
			...
			sys.stdout.flush()
			time.sleep(10. / 100)
	slowprint("\n\033[91m [+] Saindo.... Obrigado por usar minha ferramenta  \n")
	time.sleep(2)
	os.system('clear')
except KeyboardInterrupt:
	print( "\n\033[90m [-] Vejo você de novo ^-^ ")
